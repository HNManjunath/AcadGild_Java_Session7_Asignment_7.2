...
public class Assignment7_2 {
	...
	public void displaySortedString(String userInput) {
		...
		for (int i = 0; i < stringSplit.length; i++) { // Loop to sort alphabets in each word of the above user entered
														// string
	...
	public static void main(String[] args) {
		Assignment7_2 Assignment7_2 = new Assignment7_2(); // Object of the Class

		Scanner userInput = new Scanner(System.in); // Scanner to get the user input from the console
		System.out.println("Enter the string ");

		Assignment7_2.displaySortedString(userInput.nextLine()); // Calling the sorting method from the class object
